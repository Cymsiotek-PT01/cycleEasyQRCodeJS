...
(function() {
    ...
    var Drawing = !_isSupportCanvas() ? (function() {
        ...
        Drawing.prototype.draw = function(oQRCode) {
            ...
            //1.Draw title Start
            if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
            ...
            //Draw Qrcode End
            //Draw Title on the bottom
            if(_htOption.titlePosition==TITLEPOSITION.BOTTOM){
                aHTML.push('<tr height="' + _htOption.titleHeight +
                    '" align="center"><td style="border:0;border-collapse:collapse;margin:0;padding:0" colspan="' +
                    nCount +
                    '">')
            ...
            if (_htOption.backgroundImage) {
                ...
                bgImg.onload = function() {
                    ...
                    if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
                        ...
                        _oContext.drawImage(bgImg, 0, 0, _htOption.width + _htOption.quietZone * 2, _htOption.height + _htOption.quietZone * 2 - _htOption.titleHeight);
                    }
            ...
            function drawQrcode(oQRCode) {
                ...
                for (var row = 0; row < nCount; row++) {
                    for (var col = 0; col < nCount; col++) {
                        ...
                        var _eyeYposition = 0;   
                        if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
                          _eyeYposition =  _htOption.titleHeight + nTop + nHeight * (1 -
                              nowDotScale) / 2 ; 
                        }
                        else{
                            _eyeYposition =  nTop + nHeight * (1 -
                                nowDotScale) / 2 ; 
                        }
                        if (eye) {
                            if (eye.type == 'AO') {
                            ...
                            /// 4.eye 位置
                            _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2, _eyeYposition, nWidth * nowDotScale, nHeight *
                                nowDotScale);
                            ...
                            if (row == 6) {
                                ...
                                if (_htOption.backgroundImage) {
                                    ...
                                    _eyeYposition, nWidth * nowDotScale, nHeight *
                                        nowDotScale);
                                } else {
                                    /// 4.eye 位置
                                    _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2,
                ...
                /// 5.畫title
                console.log("_htOption.height="+_htOption.height);
                console.log("_htOption.titleHeight="+_htOption.titleHeight);
                if (_htOption.title) {
                    ...
                    if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
                        ...
                        _oContext.fillRect(0, (_htOption.height-_htOption.titleHeight+ _htOption.quietZone*2), this._elCanvas.width, _htOption.titleHeight + _htOption
                            .quietZone);    
                    }
                    ...
                    if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
                        ...
                        _oContext.fillText(_htOption.title, this._elCanvas.width / 2, +(_htOption.height-_htOption.titleHeight)+_htOption.quietZone*2 +
                            _htOption.titleTop);                       
                    }        
                }
                /// 6.畫subtitle
                if (_htOption.subTitle) {
                    ...
                    if(_htOption.titlePosition==TITLEPOSITION.ABOVE){
                        ...
                        _oContext.fillText(_htOption.subTitle, this._elCanvas.width / 2, (_htOption.height-_htOption.titleHeight)+_htOption
                            .quietZone*2 +
                            _htOption.subTitleTop);
                    }    
                }
    ...
    QRCode = function(el, vOption) {
        this._htOption = {
            ...
            titlePosition:TITLEPOSITION.ABOVE,
   ...
   /**
     * @name QRCode.TitlePosition
     */
    QRCode.TitlePosition = TITLEPOSITION;
    /*--------------------------------------------------------------------------*/
